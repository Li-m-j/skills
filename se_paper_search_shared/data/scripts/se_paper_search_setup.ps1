...
# 用法:
#   .\se_paper_search_setup.ps1                              # 交互式
#   .\se_paper_search_setup.ps1 -Mode api -OpenAlexKey "l1..." # 非交互，API 模式
#   .\se_paper_search_setup.ps1 -Mode noapi                  # 非交互，无 API 模式
#   .\se_paper_search_setup.ps1 -Mode api -SSKey "abc..."     # 完整 API 配置
...
Write-Host " se_paper_search skill v0.1.0 - 首次设置向导" -ForegroundColor Cyan
Write-Host "=========================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "本 skill 提供统计科学 / 计量经济学 / 经济学文献检索功能，" -ForegroundColor Gray
Write-Host "支持 arXiv（免费、无需 key）、OpenAlex 和 Semantic Scholar API。" -ForegroundColor Gray
...
if ($Mode -eq 'noapi') {
    ...
    Write-Host "  切换到 API 模式:    .\se_paper_search_setup.ps1 -Mode api -OpenAlexKey 'YOUR_KEY'"
...
Write-Host "  切换模式:   .\se_paper_search_setup.ps1 -Mode noapi  (或 -Mode api -OpenAlexKey 'xxx')"
Write-Host ""
